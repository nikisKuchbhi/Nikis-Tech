...
class Bunch_Functions
{
    public function __construct()
    {
        ...
        $options = get_option('contra'.'_theme_options');
    ...
    */
    ...
    public function post_views($update = false)
    {
        global $post;
    ...
    public function format_num($number)
    {
    ...
    public function bunch_login_logo()
    {
        ?>
    ...
    public function bunch_login_stylesheet()
    {
        wp_enqueue_style('contra_custom-login', get_template_directory_uri() . '/css/style-login.css');
    }



    public function bunch_login_logo_url()
    {
    ...
    public function bunch_login_logo_url_title()
    {
