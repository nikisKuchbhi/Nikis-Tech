...
class Bunch_Base extends Bunch_Functions
{
    ...
    public function __set_attrib($attr = array())
    {
        $res = ' ';
        foreach ($attr as $k => $v) {
            $res .= $k.'="'.$v.'" ';
    ...
    public function option($key = '')
    {
        ...
        if ($key) {
            return contra_set($theme_options, $key);
        }
    ...
    public function set_term_key($post_type)
    {
        if (! $post_type) {
            return;
        }
