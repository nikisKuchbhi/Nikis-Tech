    ...
    <div class="main-box">
        <div class="inner-container clearfix">
            ...
            <div class="nav-outer">
                ...
                <?php if (contra_set($options, 'hidden_sidebar_2')): ?>
                    <!-- Main Menu End-->
                    <div class="outer-box clearfix">
                        <button class="nav-toggler"><span class="icon flaticon-menu-1"></span></button>
                    </div>
                <?php endif;?>
            </div>
        </div>
...
<section class="hidden-bar">
    <div class="inner-box">
        ...
        <div class="title">
            <h2><?php echo wp_kses_post(contra_set($options, 'form_title_1')); ?></h2>
        </div>

        <!--Appointment Form-->
        <div class="appointment-form">
            <?php echo do_shortcode(contra_set($options, 'contact_form_1')); ?>
        </div>

        <!--Contact Info Box-->
        <div class="contact-info-box">
            <ul class="info-list">
                <li><?php echo wp_kses_post(contra_set($options, 'email_5')); ?></li>
                <li><?php echo wp_kses_post(contra_set($options, 'phone_no_5')); ?></li>
            </ul>
